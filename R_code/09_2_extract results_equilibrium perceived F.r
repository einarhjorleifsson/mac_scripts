...
par(mfrow=c(2,2))
# plot for the recs
q95<-aggregate(RecT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.95)})
q75<-aggregate(RecT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.75)})
q50<-aggregate(RecT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.50)})
q25<-aggregate(RecT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.25)})
q05<-aggregate(RecT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.05)})

plot(q50$perceivedF,q50$RecT,type="l",col="red", lwd=2, xlab="perceived Fbar",ylab="Rec",main="equilibrium true F imposed",ylim=range(c(q05,q95)))
...
# plot for the recs
q95<-aggregate(SSBsT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.95)})
q75<-aggregate(SSBsT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.75)})
q50<-aggregate(SSBsT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.50)})
q25<-aggregate(SSBsT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.25)})
q05<-aggregate(SSBsT~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.05)})

plot(q50$perceivedF,q50$SSBsT,type="l",col="red", lwd=2, xlab="perceived Fbar",ylab="SSBs",main="equilibrium true F imposed",ylim=range(c(q05,q95)))
...
lines(q50$perceivedF,q50$SSBsP,lwd=2,lty="dotted")




# plot for the recs
q95<-aggregate(trueF~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.95)})
q75<-aggregate(trueF~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.75)})
q50<-aggregate(trueF~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.50)})
q25<-aggregate(trueF~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.25)})
q05<-aggregate(trueF~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.05)})

plot(q50$perceivedF,q50$trueF,type="l",col="red", lwd=2, xlab="perceived Fbar",ylab="trueF",main="equilibrium true F imposed",ylim=range(c(q05,q95)))
...
# plot for the recs
q95<-aggregate(Yields~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.95)})
q75<-aggregate(Yields~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.75)})
q50<-aggregate(Yields~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.50)})
q25<-aggregate(Yields~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.25)})
q05<-aggregate(Yields~perceivedF,data=res[res$perceivedF<=0.6,],function(x) {quantile(x,0.05)})

plot(q50$perceivedF,q50$Yields,type="l",col="red", lwd=2, xlab="perceived Fbar",ylab="Yields",main="equilibrium true F imposed",ylim=range(c(q05,q95)))
